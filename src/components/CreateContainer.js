    ...
    return (
        <div className='w-full min-h-screen flex items-center justify-center'>
         ...
         <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2'>
            ...
            <input onChange={(e)=>setTitle(e.target.value)} className='w-full h-full text-lg bg-transparent font-semibold outline-none border-none placeholder:text-gray-400 text-textColor' type="text" placeholder='Give me a title...' id="" value={title} required  />
         </div>
