        ...
        <div className='relative'>
           ...
           className='w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-12 right-0'>
            ...
            <ul className='flex flex-col px-4 py-2 '>
                ...
                <p onClick={logout} className='m-2 p-2 rounded-md shadow-md flex justify-center bg-gray-200 items-center gap-3 cursor-pointer hover:bg-slate-300 transition-all duration-100 ease-in-out text-textColor text-base'>Logout <MdLogout/></p>
            </motion.div>)}
        </div>
    </div>
    </header>
