    ...
    return (
        ...
        <div className="w-full flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-3 items-center">
            <motion.div
              whileTap={{ scale: 0.75 }}
              className="w-8 h-8 rounded-lg bg-blue-400 hover:bg-blue-600 cursor-pointer  hover:shadow-lg flex items-center justify-center"
            ...
            <motion.div
              whileTap={{ scale: 0.75 }}
              className="w-8 h-8 rounded-lg bg-blue-400 hover:bg-blue-600 cursor-pointer transition-all duration-100 ease-in-out hover:shadow-lg flex items-center justify-center"
              onClick={() => setScrollValue(-200)}
            >
